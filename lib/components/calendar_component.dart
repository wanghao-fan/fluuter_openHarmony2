...
class _CalendarComponentState extends State<CalendarComponent> {
  ...
  void _initializeAppointments() {
    ...
    _appointments = [
      ...
      // 明天的预约
      Appointment(
        startTime: DateTime(today.year, today.month, today.day + 1, 10, 0, 0),
      ...
      // 后天的预约
      Appointment(
        startTime: DateTime(today.year, today.month, today.day + 2, 15, 0, 0),
        endTime: DateTime(today.year, today.month, today.day + 2, 16, 30, 0),
        subject: '技术评审',
        color: Colors.red,
        isAllDay: false,
      ),
      // 大后天的预约
      Appointment(
        startTime: DateTime(today.year, today.month, today.day + 3, 13, 0, 0),
        endTime: DateTime(today.year, today.month, today.day + 3, 14, 0, 0),
        subject: '周会',
        color: Colors.purple,
        isAllDay: false,
      ),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: const Text(
              '日历组件用于显示和管理日程安排，支持日程视图展示。点击预约可查看详细信息。',
              style: TextStyle(
                fontSize: 14,
                color: Colors.deepPurple,
              ),
